 ...
 * false otherwise
 */
bool queue_push_back(Queue_t *q, char* data);
/**
 * @brief Removes an element from the front of the Queue, returning it in the process
 * 
 * @param q Pointer to the Queue to operate over
 * @return char* The data of the element popped on success\n
 * NULL otherwise
 */
 ...
 * 
 * @param q Pointer to the Queue to operate over
 * @return char* The data of the element on the back of the Queue on success\n
 * NULL otherwise
 */
 ...
 * @param q Pointer to the Queue to operate over
 * 
 * @return char* Pointer to the data of the element on the front of the Queue on success\n
 * NULL otherwise
 */
